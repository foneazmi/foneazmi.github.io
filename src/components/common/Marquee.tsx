...
export const Marquee = memo(({ skills }: MarqueeProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-20 bg-[radial-gradient(circle_at_center,transparent_20%,#030014_100%)]" />
      <div className="absolute inset-y-0 left-0 w-32 bg-linear-to-r from-[#030014] to-transparent z-20" />
      <div className="absolute inset-y-0 right-0 w-32 bg-linear-to-l from-[#030014] to-transparent z-20" />
