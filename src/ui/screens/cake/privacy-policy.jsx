  ...
  return (
    <div className="p-4 overflow-auto mb-16">
      ...
      <p>
        ...
        SERVICE is provided by Farkhan Azmi at no cost and is intended for use
        as is.
      </p>
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at Cake (Catatan Keuangan)
      ...
      <h1 className="font-bold mt-4">Cookies</h1>
      <p>
      ...
      <h1 className="font-bold mt-4">Service Providers</h1>
      <p>
      ...
      <h1 className="font-bold mt-4">Security</h1>
      <p>
      ...
      <h1 className="font-bold mt-4">Links to Other Sites</h1>
      <p>
      ...
      <h1 className="font-bold mt-4">Children's Privacy</h1>
      <div>
        <p>
      ...
      <h1 className="font-bold mt-4">Changes to This Privacy Policy</h1>
      <p>
      ...
      <p>
        ...
        hesitate to contact me at fliazmi@gmail.com.
      </p>
    </div>
  );
};
